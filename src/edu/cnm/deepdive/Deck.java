...
/**
 * <code>Deck</code> implements a single deck of standard playing cards. Methods are
 * included for shuffling and dealing cards from the deck.
 * @author Felipe Cook &amp; Nicholas Bennett
 * @version 1.0
 */
...
public class Deck {
  ...
  /**
   * Initializes the deck with all 52 cards, in order. The {@link #shuffle(Random)} method
   * must be invoked after initialization, prior to dealing any cards
  ...
  /**
   * Deals and returns one card from the top of the pile. If no cards are in the pile
   * a {@link DeckEmptyException} will be thrown.
   *
   * @return single card form the top of pile.
